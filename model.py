...
class GarchModel:
    ...
    def __init__(self, ticker, repo, use_new_data):
        ...
        self.the_model_directory = settings.the_model_directory
    ...
    def fit(self, p, q,):
        ...
        # Assign AIC and BIC to the model object
    ...
    def dump(self):
        ...
        if not os.path.exists(self.the_model_directory):
            raise FileNotFoundError(f"Directory {self.the_model_directory} does not exist.")
        # Create filepath, including `self.model_directory`
        filepath = os.path.join(self.the_model_directory, f"{timestamp}_{self.ticker}.pkl")
    ...
    def load(self):
        ...
        pattern = os.path.join(self.the_model_directory, f"*{self.ticker}.pkl")
